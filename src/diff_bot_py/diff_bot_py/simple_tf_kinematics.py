...
from diff_bot_msgs.srv import GetTransform
...
class SimpleTfKinematics(Node):
    ...
    def __init__(self):
        ...
        self.static_transform_stamped_.header.frame_id = "diff_bot_base"
        self.static_transform_stamped_.child_frame_id =  "diff_bot_top"
    ...
    def timerCallback(self):
        ...
        self.dynamic_transform_stamped_.child_frame_id = "diff_bot_base"
