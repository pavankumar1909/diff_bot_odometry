...
private: 
    ...
    bool getTransformCallback(const std::shared_ptr<diff_bot_msgs::srv::GetTransform::Request> req,
                              const std::shared_ptr<diff_bot_msgs::srv::GetTransform::Response> res);

    rclcpp::TimerBase::SharedPtr timer_;
    rclcpp::Service<diff_bot_msgs::srv::GetTransform>::SharedPtr get_transform_srv_;
