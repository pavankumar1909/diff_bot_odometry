      ...
      rotations_counter_(0)
{
  ...
  static_transform_stamped_.header.frame_id = "diff_bot_base";
  static_transform_stamped_.child_frame_id = "diff_bot_top";
  ...
  // Service Server
  get_transform_srv_ = create_service<diff_bot_msgs::srv::GetTransform>("get_transform", std::bind(&SimpleTfKinematics::getTransformCallback, this, _1, _2));
...
{  
  ...
  dynamic_transform_stamped_.child_frame_id = "diff_bot_base";
...
bool SimpleTfKinematics::getTransformCallback(const std::shared_ptr<diff_bot_msgs::srv::GetTransform::Request> req,
                                              const std::shared_ptr<diff_bot_msgs::srv::GetTransform::Response> res)
{
